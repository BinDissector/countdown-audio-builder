...
def parse_args(argv: Optional[List[str]] = None) -> Settings:
    ...
    p.add_argument("--start", type=int, default=80, help="Starting integer for countdown (inclusive).")
    p.add_argument("--interval", type=float, default=3.5, help="Seconds between normal cues.")
    ...
    p.add_argument("--skip-first-rest", type=int, default=0, help="Number of initial rest periods to skip.")  # NEW
